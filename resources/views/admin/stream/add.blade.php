...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="datetime-local" class="input-text" placeholder="" name="permited_at" id="permited" value="0">
            </div>
        </div>
        {{--csrf隐藏域--}}
        {{csrf_field()}}
...
<script type="text/javascript">
    $(function(){
        ...
        //初始化时默认隐藏两个表单项
        // $('#controller,#sort').parents('.row').hide()
        // //给下拉列表绑定切换事件
        ...
        //     if (_val > 0){
        //         //显示
        //         $('#controller,#sort').parents('.row').show(300)
        //     } else {
        //         //隐藏
        //         //重置表单项里的值
        //         $('#controller,#sort').val('');
        //         $('#controller,#sort').parents('.row').hide(300)
        //     }
        // });
